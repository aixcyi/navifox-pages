        ...
        <section class="mx-8">
            <ul>
                ...
                <AiTimelineItem color="#A349A4" date="2020 年 12 月">
                    <Markdown>找到一处名为 GitHub 的乐园，取“砹小翼”双拼拼音 `aixcyi` 为常用 ID，翻开岁月史书</Markdown>
                ...
                <AiTimelineItem color="#A349A4" date="2024 年 1 月">
                    注册并备案以常用 ID 为域名的
                ...
                <AiTimelineItem color="#A44967" color2="#FF7F27" date="2024 年 7 月" markdown>
                    受
                    [Csense](https://plugins.jetbrains.com/vendor/fab53479-05ec-4e6d-a40e-05df95be4921)
                ...
                <AiTimelineItem color="#FF7F27" date="2025 年 6 月" markdown>
                    为了更喜爱的狐狸，移居
                    [`navifox.net`](https://navifox.net/)，并为小站定名
