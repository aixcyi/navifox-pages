...
export const spiritsOC: SpiritInfo[] = [
    // 在此处添加更多妖灵...
    {
        ...
        avatar: '/assets/spirit/qingling.jpg',
        link: '/spirit/qingling',
    },
    {
        name: '绛棂',
        tags: ['临川会馆下派榕城外事部组长', '二级执行者'],
        avatar: '/assets/spirit/jiangling.jpg',
        link: '/spirit/jiangling',
    },
    {
        name: '初岚',
        tags: ['一条咸鱼（师父养我）'],
        avatar: '/assets/spirit/chulan.jpg',
        link: '/spirit/chulan',
    },
    {
        name: '邔符',
        tags: ['粤东管理', '一级执行者'],
        avatar: '/assets/spirit/wensley.jpg',
        link: '/spirit/wensley',
    },
    {
        name: '念月',
        tags: ['苍南会馆跨境追缉组组长', '一级执行者', '无限大徒弟'],
        avatar: '/assets/spirit/nuray.jpg',
        link: '/spirit/nuray',
    },
    {
        name: '济慈',
        tags: ['苍南会馆下属前攻组组长', '一级执行者'],
        avatar: '/assets/spirit/keats.jpg',
        link: '/spirit/keats',
    },
    {
        name: '攸往',
        tags: ['苍南会馆常驻妖精', '总馆落云组组长', '一级执行者'],
        avatar: '/assets/spirit/ziyouwang.jpg',
    ...
    },
    {
        name: '兰知',
        tags: ['临川会馆画师'],
        avatar: '/assets/spirit/lanzhi.jpg',
        link: '/spirit/lanzhi',
    },
    {
        name: '念一',
        tags: ['<i>只是一个游历于世界各地的旅行者</i>'],
        avatar: '/assets/spirit/killing.jpg',
        link: '/spirit/killing',
    },
    {
        name: '拾七',
