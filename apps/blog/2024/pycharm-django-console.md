...
![设置页面](/assets/django-console-search-cn.webp)

Search "console" by settings searcher if you are using English:

![Settings Page](/assets/django-console-search-en.webp)
